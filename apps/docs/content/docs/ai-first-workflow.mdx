...
**Product north star:** School OS is the trust engine for Pakistani school networks (AKES
reference). AI assists that loop — early warnings, draft report comments, parent FAQ — with human
approval. It does not replace the scan→WhatsApp→dashboard hook that sells pilots.
